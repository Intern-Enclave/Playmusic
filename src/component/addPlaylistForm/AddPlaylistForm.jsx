...
function AddPlaylistForm(props) {
    ...
    const option1 = () => {
        const modal = document.querySelector(".option-button1");
        if (modal.className == "option-button1")
            modal.className = "option-button1 on";
        else 
            modal.className = "option-button1";
    }

    const option2 = () => {
        const modal = document.querySelector(".option-button2");
        if (modal.className == "option-button2")
            modal.className = "option-button2 on";
        else 
            modal.className = "option-button2";
    }
            ...
            <div className='create-playlist-container'>
                <div className='create-playlist-content'>
                    <div className='create-playlist-from-content'>                     
                        ...
                        <input className='create-playlist-name-input' placeholder='Type your playlist name'></input>
