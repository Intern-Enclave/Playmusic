...
const Home = () => {
  const { listTrack, setAlbumId, setImga, setSingername, handleChooseSong } =
    useMusic();
    ...
    <div className="home-page-container">
      <div className="topic-music">
        ...
        <Carousel show={3}>
          {listAlbum?.map((val) => (
            <Link
              to={"/album_id"}
              className="topic-item carousel-item"
              key={val.id}
              onClick={() => setAlbumId(val.id)}
            >
              <div style={{ padding: 8 }}>
                <img
                  src={val.cover_big}
      ...
      <div className="playlists-music">
        <div className="playlists-music-header">
          ...
          <Link to={"/newsong"} className="playlists-more more">
            More
          </Link>
        </div>
      ...
      <div className="top-music">
        <div className="top-music-header ">
          ...
          <Link to={"/topmusic"} className="tops-more more">
            More
          </Link>
        </div>
        ...
        <div className="singer-context">
          <div className="singer-content">
            <div className="singer-header">
              ...
              <Link to={"/singer"} className="singer-more more">
                More
              </Link>
            </div>
